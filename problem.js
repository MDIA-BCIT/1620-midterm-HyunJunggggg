...
function passwordCheckingSystem(password, userInput) {
  ...
  } if (password !== userInput || userInput === "forgot" ) {
    console.log("Here is a hint");
  } if (password !== userInput || userInput === "reset") {
    console.log("Let's reset your account") 
  }
}


// if (password !== usersInput && usersInput === "forgot") {
//   console.log("Here is a hint");
// } if (usersInput === "reset") {
//   console.log("Let's reset your account") 
// }
// if (accessGranted && (password ===("forgot"||"reset"))){
//   console.log("This password you set should not be used because it glitches the system");
// }
// function - password checking system
// password , usersInput
// if input === password , "Access Granted!"
// if input !== password, "Access Denied!"
// if input === "forgot" , "Here is a hint"
// if input === "reset" , "Let's reset your account"

// challenge 
//  //  else if (password !== userInput && userInput === ("forgot" || "reset") ){
  //  console.log("This password you set should not be used because it glitches the system");
